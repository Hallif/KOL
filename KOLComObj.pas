...
{$IMPORTEDDATA ON}
unit KOLComObj;{$IFDEF FPC}{$MODE delphi}{$ENDIF}
...
procedure GetIDsOfNames(const Dispatch: IDispatch; Names: PChar; NameCount: Integer; DispIDs: PDispIDList);
...
procedure DispCall(const Dispatch: IDispatch; CallDesc: PCallDesc; DispID: Integer; NamedArgDispIDs, Params, Result: Pointer); stdcall;
type
